...
class TopBar(ResizableFrame):
    ...
    def _create_buttons(self):
        ...
        molecule_menu.add_command(label="HITRAN Query", command=lambda: print("HITRAN Query"))
        molecule_menu.add_command(label="Default Molecules", command=lambda: print("Default Molecules"))
        molecule_menu.add_command(label="Add Molecules", command=lambda: print("Add Molecules"))
        ...
        spectrum_menu.add_command(label="Save Parameters", command=lambda: print("Save Parameters"))
        spectrum_menu.add_command(label="Load Parameters", command=lambda: print("Load Parameters"))
